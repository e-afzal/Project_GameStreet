...
import { listAccessoryDetails } from "../actions/productActions";
...
const ConsoleScreen = ({ match, history }) => {
  ...
  useEffect(() => {
    dispatch(listAccessoryDetails(match.params.id));
  }, [dispatch, match]);

  // SPLIT FEATURES
  let splitFeatures;
  splitFeatures =
    accessory.productFeatures && accessory.productFeatures.split("|");
  ...
  return (
    <>
      <Metatag title={accessory.title && accessory.title} />
      <ScrollToTop />
      ...
      <section id="product-content">
        ...
        <div className="product-details">
          <div className="product-brief">
            ...
            <h4 className="product-price">
              AED {accessory.price && accessory.price.toFixed(2)}
            </h4>
            <hr />
            ...
            <form className="cart-form">
              ...
              <button
                ...
                style={{
                  backgroundColor: `${
                    accessory.countInStock && accessory.countInStock > 0
                      ? "#20b830"
                      : "#dc143c"
                  }`,
                }}
                disabled={accessory.countInStock < 1}
              >
                {accessory.countInStock < 1 ? "Out of Stock" : "Add to Cart"}
              </button>
              <small
                style={{
                  textAlign: "center",
          ...
          <div className="about-product">
            ...
            <p className="about-description">
              {accessory.productDescription && accessory.productDescription}
            </p>
          </div>
        ...
        <div className="product-gallery">
          <h1>Image Gallery</h1>
          {accessory.productImages && (
            <ProductSwiper images={accessory.productImages} />
          )}
        </div>
      </section>
    </>
