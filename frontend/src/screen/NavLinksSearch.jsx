...
const NavLinksSearch = ({ match }) => {
  const paramsPlatform = match.params.platform;
  const paramsProduct = match.params.product;

  // CONSTS
  let [category, setCategory] = useState(paramsProduct);
  let [availability, setAvailability] = useState("");
  let [price, setPrice] = useState("");
  let [platform, setPlatform] = useState(paramsPlatform);
  ...
  useEffect(() => {
    ...
    fetchProducts();
  }, [category, price, availability, platform]);
    ...
    <>
      ...
      <section id="search-grid">
        ...
        <div className="search-results">
          <p className="results-mobile">
            Showing {result && result.length}{" "}
